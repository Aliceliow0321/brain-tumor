...
filename='model_train_vgg_reference.csv'
filepath="Best-weights-vgg_reference-{epoch:03d}-{loss:.4f}-{acc:.4f}.hdf5"
...
plt.show()
fig.savefig("C:/Users/user/Desktop/psm/gui/img/Normalized confusion matrix vgg reference" + '.png')
...
model.save_weights("model_vgg_reference.h5")
...
loaded_model.load_weights("model_vgg_reference.h5")
print("Loaded model from disk")
model.save('C:/Users/user/Desktop/psm/gui/model/model_vgg_reference.hdf5')
loaded_model=load_model('C:/Users/user/Desktop/psm/gui/model/model_vgg_reference.hdf5')
