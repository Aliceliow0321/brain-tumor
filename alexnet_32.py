...
filename='model_train_alexnet_f(32).csv'
filepath="Best-weights-32_alexnet_model-{epoch:03d}-{loss:.4f}-{acc:.4f}.hdf5"
...
# Testing
hist = model.fit(X_train, y_train, batch_size=20, epochs=1, verbose=1, validation_data=(X_test, Y_test),callbacks=callbacks_list)
...
#print(y_pred)
target_names = ['class 0(malignent)', 'class 1(benign)','class 2(normal)']
...
plt.show()
fig.savefig("C:/Users/user/Desktop/psm/gui/img/Normalized confusion matrix alexnet 32" + '.png')
...
model.save_weights("model_alexnet32.h5")
...
loaded_model.load_weights("model_alexnet32.h5")
print("Loaded model from disk")
model.save('C:/Users/user/Desktop/psm/gui/model/model_alexnet32.hdf5')
loaded_model=load_model('C:/Users/user/Desktop/psm/gui/model/model_alexnet32.hdf5')
