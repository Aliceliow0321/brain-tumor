...
filename='model_train_alexnet_64.csv'
filepath="Best-weights-64_alexnet_refer-{epoch:03d}-{loss:.4f}-{acc:.4f}.hdf5"
...
plt.show()
fig.savefig("C:/Users/user/Desktop/psm/gui/img/Normalized confusion matrix alexnet 64" + '.png')
...
model.save_weights("model_alexnet_64.h5")
...
loaded_model.load_weights("model_alexnet_64.h5")
print("Loaded model from disk")
model.save('C:/Users/user/Desktop/psm/gui/model/model_alexnet_64.hdf5')
loaded_model=load_model('C:/Users/user/Desktop/psm/gui/model/model_alexnet_64.hdf5')
