...
filename='model_train_vgg_f(32).csv'
filepath="Best-weights-32_vgg_model-{epoch:03d}-{loss:.4f}-{acc:.4f}.hdf5"
...
plt.show()
fig.savefig("C:/Users/user/Desktop/psm/gui/img/Normalized confusion matrix vgg 32" + '.png')
...
model.save_weights("model_vgg32.h5")
...
loaded_model.load_weights("model_vgg32.h5")
print("Loaded model from disk")
model.save('C:/Users/user/Desktop/psm/gui/model/model_vgg32.hdf5')
loaded_model=load_model('C:/Users/user/Desktop/psm/gui/model/model_vgg32.hdf5')
