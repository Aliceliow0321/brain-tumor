...
model.add(Convolution2D(192, 5, 5))
model.add(Activation('relu'))
model.add(MaxPooling2D(pool_size=(3, 3)))
...
filename='model_train_alexnet_reference.csv'
filepath="Best-weights-32_alexnet_refer-{epoch:03d}-{loss:.4f}-{acc:.4f}.hdf5"
...
plt.show()
fig.savefig("C:/Users/user/Desktop/psm/gui/img/Normalized confusion matrix alexnet reference" + '.png')
...
model.save_weights("model_alexnet_reference.h5")
...
loaded_model.load_weights("model_alexnet_reference.h5")
print("Loaded model from disk")
model.save('C:/Users/user/Desktop/psm/gui/model/model_alexnet_reference.hdf5')
loaded_model=load_model('C:/Users/user/Desktop/psm/gui/model/model_alexnet_reference.hdf5')
